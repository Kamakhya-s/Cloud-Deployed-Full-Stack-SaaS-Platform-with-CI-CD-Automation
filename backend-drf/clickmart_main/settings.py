...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-dev-fallback-key-change-in-production')
...
STATICFILES_DIRS = [
    BASE_DIR / 'clickmart_main' / 'static'
] if (BASE_DIR / 'clickmart_main' / 'static').is_dir() else []
